...
- **Imágenes e Ilustraciones Visuales:**
  ...
  - **Imágenes Generadas por IA:** Las imágenes de *Game Over* (por fallo en cada módulo) fueron generadas con herramientas de Inteligencia Artificial utilizando técnicas de prompt engineering (descripción textual) para adaptarlas al contexto del proyecto.
...
4. **Generación de Imágenes de 'Game Over':** Se utilizó IA generativa de imágenes. Yo mismo preparé los *prompts* detallados y describí la composición exacta de la imagen, los colores y los elementos que quería que aparecieran para cada módulo (HTML, CSS, JS y React).
